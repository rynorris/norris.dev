...
/******/ 	return __webpack_require__(__webpack_require__.s = "./bootstrap_worker.js");
/******/ })
/************************************************************************/
/******/ ({
...
eval("// A dependency graph that contains any wasm must all be imported\n// asynchronously. This `bootstrap.js` file does the single async import, so\n// that no one else needs to worry about it again.\n__webpack_require__.e(/*! import() */ 1).then(__webpack_require__.t.bind(null, /*! ./worker.js */ \"./worker.js\", 7))\n  .catch(e => console.error(\"Error importing `worker.js`:\", e));\n\n\n//# sourceURL=webpack:///./bootstrap_worker.js?");
